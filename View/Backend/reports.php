  ...
  <div class="container">
    <?php if(!empty($comments)):
      foreach($comments as $comment): ?>
        <p>
          <b>Numéro du commentaire: </b>
          <a href="index.php?route=post&id=<?= $comment->id_post; ?>#myComment-<?= $comment->id_comment; ?>">
            <?= $comment->id_comment; ?>
          </a>
          <span id="nb_report">
            <strong>Nombre de signalement:</strong>
            <?= $comment->nb_report ?>
          </span>
        </p>
      ...
      <?php endforeach;
        ...
        <p>Il n'y a pas de signalement !</p>
    <?php endif; ?>
  </div>
